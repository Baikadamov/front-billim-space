...
const Sidebar = () => {
    ...
    // Check if the current path is not '/login' or '/registration'
    if (currentPath !== '/login' && currentPath !== '/registration') {
        return (
            <div>
                <button onClick={toggleSideBar} data-drawer-target="default-sidebar"
                            ...
                            <li className={`flex`}>
                                <a href="#"
                                   className="flex items-center px-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    {currentUser && (
                                        <span
                                            className=" ">{currentUser.user.role === 'TEACHER' ? 'Преподователь' : 'Студент'}</span>
                                    )}
                                </a>
                            </li>
                            {currentUser && (
                                <span className="px-2 text-sm"> {currentUser.user.email}</span>
                            )}
                            <li className={`flex`}>
                                <a href="/grades"
                                   className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="ml-3">Оценки</span>
                                </a>
                            ...
                            <li>
                                <a href="/"
                                   className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Курсы</span>
                                </a>
                            </li>
                                ...
                                <li>
                                    <a href="/create-task"
                                       className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                        ...
                                        <span className="flex-1 ml-3 whitespace-nowrap">Создать новое задание</span>
                                    </a>
                                </li>
                            )}
                            <li>
                                <a href="/all-users"
                                   className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    <span className="flex-1 ml-3 whitespace-nowrap">Все пользователи</span>
                                </a>
                            </li>
                            <li>
                                <a onClick={logOut} href="/login"
                                   className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                    ...
                                    {currentUser ?
                                        (<span className="flex-1 ml-3 whitespace-nowrap">Выйти из аккаунта</span>) :
                                        (<p></p>)
                                    }
